...
router.post('/', protect, upload.single('file'), ownUserSuperUserEditorGuard, createMarriageDocument);
router.get('/', protect, getMarriageDocuments);
router.get('/:id', protect, getMarriageDocumentById);
router.put('/:id', protect, ownUserSuperUserEditorGuard, updateMarriageDocument);
