...
const allowedOrigins = ['http://localhost:5173', 'http://localhost:4200', 'https://christian-biodata-git-main-joshmiths-projects.vercel.app/', 'https://christian-biodata-frontend.vercel.app'];
